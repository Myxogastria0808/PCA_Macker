shinyServer(function(input, output) {
  ...
  plotInput2 <- function() {
    ...
    inFile[input$column_start16:input$column_end16,] <- inFile[input$column_start16:input$column_end16,] + 16
    inFile[input$column_start17:input$column_end17,] <- inFile[input$column_start16:input$column_end17,] + 17
    inFile[input$column_start18:input$column_end18,] <- inFile[input$column_start18:input$column_end18,] + 18
    inFile[input$column_start19:input$column_end19,] <- inFile[input$column_start19:input$column_end19,] + 19
    inFile[input$column_start20:input$column_end20,] <- inFile[input$column_start20:input$column_end20,] + 20
    ...
    component_number16 <- input$column_end16 - input$column_end15
    component_number17 <- input$column_end17 - input$column_end16
    component_number18 <- input$column_end18 - input$column_end17
    component_number19 <- input$column_end19 - input$column_end18
    component_number20 <- input$column_end20 - input$column_end19
    ...
    inFile<- cbind(c(rep(input$component1, input$column_end1),
                     ...
                     rep(input$component16, component_number16),
                     rep(input$component17, component_number17),
                     rep(input$component18, component_number18),
                     rep(input$component19, component_number19),
                     rep(input$component20, component_number20)),
                   inFile)
    ...
    ggbiplot(pcobj = pca2, choices = 1:2, obs.scale = 0.5, var.scale = 2,
      ...
      scale_colour_manual(values = c(input$color1, input$color2, input$color3, input$color4, input$color5, input$color6, input$color7, input$color8, input$color9, input$color10,
                                     input$color11, input$color12, input$color13, input$color14, input$color15, input$color16, input$color17, input$color18, input$color19, input$color20)) +
