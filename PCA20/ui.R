...
shinyUI(fluidPage(
  ...
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start6", 
                        label = h3("Start Column of 6th Factor"), 
                        value = 12)
    ),
    column(width = 6,
           #number6
           numericInput("column_end6", 
                        label = h3("End Column of 6th Factor"), 
                        value = 13)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start7", 
                        label = h3("Start Column of 7th Factor"), 
                        value = 14)
    ),
    column(width = 6,
           #number7
           numericInput("column_end7", 
                        label = h3("End Column of 7th Factor"), 
                        value = 15)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start8", 
                        label = h3("Start Column of 8th Factor"), 
                        value = 16)
    ),
    column(width = 6,
           #number8
           numericInput("column_end8", 
                        label = h3("End Column of 8th Factor"), 
                        value = 17)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start9", 
                        label = h3("Start Column of 9th Factor"), 
                        value = 18)
    ),
    column(width = 6,
           #number9
           numericInput("column_end9", 
                        label = h3("End Column of 9th Factor"), 
                        value = 19)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start10", 
                        label = h3("Start Column of 10th Factor"), 
                        value = 20)
    ),
    column(width = 6,
           #number10
           numericInput("column_end10", 
                        label = h3("End Column of 10th Factor"), 
                        value = 21)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start11", 
                        label = h3("Start Column of 11th Factor"), 
                        value = 22)
    ),
    column(width = 6,
           #number11
           numericInput("column_end11", 
                        label = h3("End Column of 11th Factor"), 
                        value = 23)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start12", 
                        label = h3("Start Column of 12th Factor"), 
                        value = 24)
    ),
    column(width = 6,
           #number12
           numericInput("column_end12", 
                        label = h3("End Column of 12th Factor"), 
                        value = 25)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start13", 
                        label = h3("Start Column of 13th Factor"), 
                        value = 26)
    ),
    column(width = 6,
           #number13
           numericInput("column_end13", 
                        label = h3("End Column of 13th Factor"), 
                        value = 27)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start14", 
                        label = h3("Start Column of 14th Factor"), 
                        value = 28)
    ),
    column(width = 6,
           #number14
           numericInput("column_end14", 
                        label = h3("End Column of 14th Factor"), 
                        value = 29)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start15", 
                        label = h3("Start Column of 15th Factor"), 
                        value = 30)
    ),
    column(width = 6,
           #number15
           numericInput("column_end15", 
                        label = h3("End Column of 15th Factor"), 
                        value = 31)
    ),
  ),
  fluidRow(
  ...
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start17", 
                        label = h3("Start Column of 17th Factor"), 
                        value = 34)
    ),
    column(width = 6,
           #number17
           numericInput("column_end17", 
                        label = h3("End Column of 17th Factor"), 
                        value = 35)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start18", 
                        label = h3("Start Column of 18th Factor"), 
                        value = 36)
    ),
    column(width = 6,
           #number18
           numericInput("column_end18", 
                        label = h3("End Column of 18th Factor"), 
                        value = 37)
    ),
  ),
  fluidRow(
    column(width = 6,
           ...
           numericInput("column_start19", 
                        label = h3("Start Column of 19th Factor"), 
                        value = 38)
    ),
    column(width = 6,
           #number19
           numericInput("column_end19", 
                        label = h3("End Column of 19th Factor"), 
                        value = 39)
    ),
  ),
  fluidRow(
    column(width = 6,
           #number20
           numericInput("column_start20", 
                        label = h3("Start Column of 20th Factor"), 
                        value = 40)
    ),
    column(width = 6,
           #number20
           numericInput("column_end20", 
                        label = h3("End Column of 20th Factor"), 
                        value = 41)
    ),
  ),
  h3(id = "h3_label",
  ...
  fluidRow(
    column(width = 6,
           #component 11
           textInput("component11",label=h3("Label of 11th Factor"))
    ),
    column(width = 6,
           #component 12
           textInput("component12",label=h3("Label of 12th Factor"))
    )
  ),
  fluidRow(
    column(width = 6,
           #component 13
           textInput("component13",label=h3("Label of 13th Factor"))
    ),
    column(width = 6,
           #component 14
           textInput("component14",label=h3("Label of 14th Factor"))
    )
  ),
  fluidRow(
    column(width = 6,
           #component 15
           textInput("component15",label=h3("Label of 15th Factor"))
    ),
    column(width = 6,
           #component 16
           textInput("component16",label=h3("Label of 16th Factor"))
    )
  ),
  fluidRow(
    column(width = 6,
           #component 17
           textInput("component17",label=h3("Label of 17th Factor"))
    ),
    column(width = 6,
           #component 18
           textInput("component18",label=h3("Label of 18th Factor"))
    )
  ),
  fluidRow(
    column(width = 6,
           #component 19
           textInput("component19",label=h3("Label of 19th Factor"))
    ),
    column(width = 6,
           #component 20
           textInput("component20",label=h3("Label of 20th Factor"))
    )
  ),
  h3(id = "h3_label",
     "Color of Factors"),
  ...
  fluidRow(
    column(width = 6,
           #color11
           selectInput("color11", label = h3("Color of 11th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
    ...
    column(width = 6,
           #color12
           selectInput("color12", label = h3("Color of 12th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
  ...
  fluidRow(
    column(width = 6,
           #color13
           selectInput("color13", label = h3("Color of 13th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
    ...
    column(width = 6,
           #color14
           selectInput("color14", label = h3("Color of 14th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
  ...
  fluidRow(
    column(width = 6,
           #color15
           selectInput("color15", label = h3("Color of 15th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
    ...
    column(width = 6,
           #color16
           selectInput("color16", label = h3("Color of 16th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
  ...
  fluidRow(
    column(width = 6,
           #color17
           selectInput("color17", label = h3("Color of 17th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
    ...
    column(width = 6,
           #color18
           selectInput("color18", label = h3("Color of 18th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
  ...
  fluidRow(
    column(width = 6,
           #color19
           selectInput("color19", label = h3("Color of 19th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
    ...
    column(width = 6,
           #color20
           selectInput("color20", label = h3("Color of 20th Factor"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
