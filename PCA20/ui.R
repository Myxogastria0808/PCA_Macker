...
shinyUI(fluidPage(
  ...
  fluidRow(
    column(width=6,
           ...
           numericInput("column_start20", 
                        label = h3("Start Column of Element 20"), 
                        value = 39)
    ),
    column(width=6,
           #number20
           numericInput("column_end20", 
                        label = h3("End Column of Element 20"), 
                        value = 40)
    )
  ),
  h3(id = "h3_label",
  ...
  fluidRow(
    ...
    column(width=6,
           #component 20
           textInput("component20",label=h3("Element 20 Name")),
    ),
  ),
  h3(id = "h3_label",
     "Elements Colors"),
  ...
  fluidRow(
    ...
    column(width=6,
           #color20
           selectInput("color20", label = h3("Element 20 Color"), 
                       choices = list("Violet" = "blueviolet",
                                      "Blue" = "blue",
                                      "Vermilion" = "brown1",
                                      "Turquoise" = "cadetblue3",
